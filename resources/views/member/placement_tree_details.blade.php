    <div class="hv-container replace" style=" min-height: 800px;">
                             ...
                             <form action="{{ url('member/tree-user-search') }}" method="post"> 
                              <div class="row ">
                                <div class="col" align="right">
                                    ...
                                    @endif" type="button" class="btn btn-success btn-sm" id="level_up" style="width: 100px; font-size: 12px;">
                                ...
                                <div class="col" align="left" >
                                   <button type="Submit" class="btn btn-primary btn-sm" id="level_back" style="width: 100px; font-size: 12px;" required="required"><i class="fa fa-level-down" style="font-size: 18px;" aria-hidden="true"></i>Submit</button>
                                </div>                               
                              </div> 
                             </form>
                              ...
                              <div class="hv-item-parent">                   
                                ...
                                @php 
                                 $member_details = DB::table('users')->where('user_id', $top_id)->first();
                                @endphp  

                                @if(!empty($member_details->image))
                                <img src="{{ asset('storage/product/'.$member_details->image) }}">              
                                @else
                                <img  src="{{ asset('images/user.png') }}">          
                                @endIf   
                                <p class="name">{{ $member_details->user_id }}</p>  
                                <div class="dropdown_custom-content">
                                      <div class="name">{{ $member_details->user_id }}</div>                          
                                      <div class="name">Rank:{{ $member_details->rank }}</div>
                                      <div class="name">L-PV:{{ $member_details->left_pv_counting }} R-PV:{{ $member_details->right_pv_counting }} </div>
                                      <div class="name">L-Carry:{{ $member_details->left_pv_flashable }} R-Carry:{{ $member_details->right_pv_flashable }} </div>
                                      <div class="name">Total PV:{{ $member_details->left_pv_counting +$member_details->right_pv_counting }}</div> 
                                </div>
                             </div>                        
                           </div>
                              ...
                              <div class="hv-item-child">                          
                                <div class="hv-item">                              
                                   <div class="hv-item-parent">                                 
                                     <div class="person dropdown_custom">    
                                        @php
                                         $top_left = DB::table('tree_manages')->where('placement_id', $member_details->user_id)->where('position', 'L')->first();
                                        @endphp  
                                        @if(!empty($top_left))                                
                                              @php
                                ...
                                <div class="hv-item-child">
                                    ...
                                    <div class="hv-item">
                                        <div class="hv-item-parent">
                                            <div class="person dropdown_custom">    
                                               @php
                                                 $top_right = DB::table('tree_manages')->where('placement_id', $member_details->user_id)->where('position', 'R')->first();
                                                @endphp  
                                                @if(!empty($top_right))                                
                                                      @php
