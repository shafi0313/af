                ...
                <div class="card">
                  <div class="card-body">
                   <a href="{{ route('/') }}">
                    ...
                    <h5 class="auth-form__title text-center mb-4">Create New Password</h5>
               <form method="post" class="needs-validation" action="{{url('password-reset-confirmation-success')}}"
