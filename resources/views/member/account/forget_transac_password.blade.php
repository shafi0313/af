        ...
        <div class="auth-form mx-auto mt-3 col-md-5 col-lg-3">
           ...
           <div class="card-body">
                    <img style="min-width: 100%" class="auth-form__logo d-table mx-auto mb-3"
                            ...
                            class="auth-form__title text-center mb-4">Reset Transaction Password</h5>   

                  @if (Session::has('message'))
                    <div class="alert alert-danger">{{ Session::get('message') }}</div>
                  @endif
                                             
                    <form method="post" class="needs-validation" action="{{url('transaction-password-reset')}}">
                        {{ csrf_field() }}
                        ...
                        <button type="submit" class="d-table mx-auto btn btn-accent btn-pill">Reset TP</button>
                    </form>
                </div>
            </div>
