        ...
        <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
                <div class="col-12 col-sm-8 text-center text-sm-left mb-0">
                    <h3 class="page-title">Member Activation BY BTC Wallet</h3>
                </div>
            </div>
                         ...
                         <div class="card-body p-0 text-center ReactTable">
                            <table class="table mb-0 rt-table">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">BTC Wallet</th>                     
    ...
    <script>
        ...
        $(document).ready(function () {
             $(document).on('click', '.edit', function ()  {
                ...
                //alert(id);
                $.ajax({
                    url: "{{ url('admin/member_activation_success') }}",
                    method: "POST",
                    dataType: 'json',
                    ...
                    success: function (data) {
                        if(data == 1){                        
                            ...
                            Toast.fire({
                                type: 'success',
                                title: 'This member is activated now'
                            })                             
                            table.ajax.reload();
                        }else{
                            Swal.fire({
            ...
            let table = $('.table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url('admin/member_activation_list') }}",
                columns: [
