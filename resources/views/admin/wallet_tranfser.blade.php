...
<script>
    $("#CategoryId").on('change', function(){
        ...
        let a = parseFloat(admission_fee) + parseFloat(board_reg_fee) + parseFloat(book_purchase) + parseFloat(monthly_fee*12) + parseFloat(exm_fee1) + parseFloat(exm_fee2) + parseFloat(exm_fee3);
        $('.ttl').text(a);
    });
