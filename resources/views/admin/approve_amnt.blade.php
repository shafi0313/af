        ...
        <div class="page-header row no-gutters py-4">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    @endif 
                    <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" id="loadingId" action="{{  url('admin/approve_amnt_req2')  }}" /> 
                        @csrf
                        <input type="hidden" value="{{ $order->id }}" name="id">
                            <div style="padding:10px;">  <h4> Student Name : {{ $student->student_name }}</h4>  <h4> Attendence Year : {{ $order->year }}</h4>
                                <div class="row">
                                <table id="customers">
                                    <thead>
                                    <tr>
                                    ...
                                    @foreach($order_d as $v)
                                        @php
                                        $product = DB::table('expenses')->where('id',$v->ex_id)->first();
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" ><input type="number" readonly required class=" input-sm" value="{{ $v->req_amnt }}" name="quantity[]" id="applynow" /></td>
                                        <td align="center" ><input type="number" required class="applynow input-sm applynow_{{ $v->id }}"  data-id="{{ $v->ex_id }}" name="approve[]" id="approve" /></td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                    <tfoot>
