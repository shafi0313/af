        ...
        <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
                <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                    <h3 class="page-title">Transfered Wallet approve</h3>
                </div>
            </div>
                         ...
                         <div class="card-body p-0 text-center ReactTable">
                            <table class="table mb-0 rt-table">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Sender User</th>
                                    <th scope="col" class="border-0">Sender Name</th>
                                    <th scope="col" class="border-0">Sender Moblile</th>  
                                    <th scope="col" class="border-0">Receiver User</th>
                                    <th scope="col" class="border-0">Receiver Name</th>
                                    <th scope="col" class="border-0">Receiver Moblile</th>
    ...
    <script>
        ...
        $(document).ready(function () {
             $(document).on('click', '.edit', function ()  {
                ...
                //alert(id);
                $.ajax({
                    url: "{{ url('admin/wallet_tran_succes') }}",
                    method: "POST",
                    dataType: 'json',
            ...
            let table = $('.table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url('admin/wallet-tran-list') }}",
                columns: [
