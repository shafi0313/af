...
@section('content')
    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-header p-1 px-2">
            <h3 id="InputHeader">Content Manage</h3>
        </div>
        <hr class="my-0">
        <form method="post" id="upload_form" enctype="multipart/form-data">
            ...
            <div class="p-3 h-100 overflow-auto">
                ...
                <div class="row px-0 mx-0 my-2">
                    <div class="form-group col-12 px-0 mb-2">
                        ...
                        <select class="form-control" name="type" id="type" required="required">
                            ...
                            <option value="2">Our Appreals</option>
                            <option value="3">OUR Causes</option>         
                            <option value="4">Our Mission</option>         
                            <option value="5">Our Gallery</option>         
                        </select>
                    </div>
                </div>
                ...
                <div class="row px-0 mx-0 my-2">
                    <div class="form-group col-12 px-0 mb-2">
                         <label for="inputCategory" class="sr-only"></label>
                         <input type="text" class="form-control w-100" name="title" id="title" placeholder="Slide Title Or Name">
                    </div>
                </div>
                ...
                <div class="row px-0 mx-0 my-2">
                    <div class="form-group col-12 px-0 mb-2">
                        <label for="inputCategory" class="sr-only"></label>
                        <textarea class="form-control" name="short_details" id="short_details" placeholder="Short Description Or Instructor Type"></textarea>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Content Manage</h5>
