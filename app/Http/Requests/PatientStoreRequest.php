...
class PatientStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'patient_img'  => 'required|image|mimes:png,jpeg,jpg,JPG,PNG,JPEG',
            'nid'          => 'required|image|mimes:png,jpeg,jpg,JPG,PNG,JPEG',
            'sonod'        => 'nullable|image|mimes:png,jpeg,jpg,JPG,PNG,JPEG',
            'prescription' => 'required|image|mimes:png,jpeg,jpg,JPG,PNG,JPEG',
        ];
    }
}
